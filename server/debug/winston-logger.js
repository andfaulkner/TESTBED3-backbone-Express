...
logFileNames.forEach(function(logFileName) {
    ...
    return fileExists(logFile, function(isFile) {
        ...
        return fs.writeFile(logFile, '', function(err) {
            return (err)
                ? console.log('creating ' + logFile + 'failed')
...
var logger = function(loggerTypeLabel, consoleLogLevel){
    ...
    return new (winston.Logger)({
        transports: [   //specify appenders here
            ...
            fileTransportFactory('silly', 'silly-log', 'excessive-data-log.log', loggerTypeLabel),

            //INFO --> FILE LOG
            fileTransportFactory('info', 'info-log', 'all-logs.log', loggerTypeLabel),
